...
<ul>
<li>Admins → <a href="admins.php">admins.md</a></li>
<li>Admin Permissions → <a href="admins-permissions.php">admins-permissions.md</a></li>
<li>Sessions → <a href="sessions.php">sessions.md</a></li>
</ul>
<h3>⚙️ Settings</h3>
<p>Control dynamic application configurations and manage authoritative, version-controlled legal documents.</p>
<ul>
<li>Overview → <a href="settings/overview.php">settings/overview.md</a></li>
<li>Content Documents → <a href="settings/content-documents.php">settings/content-documents.md</a></li>
<li>App Settings → <a href="settings/app-settings.php">settings/app-settings.md</a></li>
</ul>
<h3>🔐 RBAC</h3>
<p>Understand how access control works and how to assign the right capabilities to the right people.</p>
<ul>
<li>Overview → <a href="rbac/overview.php">rbac/overview.md</a></li>
<li>Roles → <a href="rbac/roles.php">rbac/roles.md</a></li>
<li>Permissions → <a href="rbac/permissions.php">rbac/permissions.md</a></li>
</ul>
<h3>🌍 Languages</h3>
<p>Manage the languages supported by the platform.</p>
<ul>
<li>Languages → <a href="languages.php">languages.md</a></li>
</ul>
<h3>🔤 Translations</h3>
<p>Precisely control the translated text displayed to users.</p>
<ul>
<li>Main Guide → <a href="translations.php">translations.md</a></li>
<li>Overview → <a href="translations/overview.php">translations/overview.md</a></li>
<li>Scopes → <a href="translations/scopes.php">translations/scopes.md</a></li>
<li>Domains → <a href="translations/domains.php">translations/domains.md</a></li>
</ul>
