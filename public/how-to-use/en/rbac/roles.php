...
<h2>Roles List</h2>
<p>When you open the Roles section, you will see a table of all existing roles.</p>
<ul>
<li><strong>Table Columns:</strong> The table displays the name of each Role and its current status.</li>
<li><strong>Actions:</strong> You can click the <strong>View</strong> or <strong>Edit</strong> buttons next to an existing role, or click the <strong>Create Role</strong> button to add a new one.</li>
<li><strong>Filters and Search:</strong> Above the table, there is a global search bar to instantly find roles by name or group. You can also click the quick-filter badges to view "All", "Active", or "Inactive" roles. Additionally, a dedicated filter form allows you to search specifically by Role ID, Name, or Group, complete with a Reset button to clear active filters.</li>
</ul>
...
4. Clicking a toggle immediately enables or disables that permission for the role.</p>
<ul>
<li><strong>Result:</strong> Changing a toggle instantly updates the role's access rights across the entire platform.</li>
</ul>
...
<p>Because roles are tied directly to an administrator's session, any modifications take effect immediately.</p>
<ul>
<li><strong>Sidebar updates:</strong> If you add or remove permissions that control entire sections of the platform (like the "Settings" menu), that link will instantly appear or disappear from the left sidebar of any administrator holding that role.</li>
<li><strong>Buttons appear/disappear:</strong> If you add or remove specific action permissions (like "Create Admin"), that specific button will instantly become visible or be hidden on the relevant pages.</li>
<li>If an administrator is actively viewing a page that a role change just revoked access to, the system will block them the next time they click a button or refresh the page.</li>
</ul>
