 ...
 * - Select2 (select2.js)
 * - LanguagesHelpersV2 (languages-helpers.js)
...
(function() {
    ...
    // Check dependencies
    if (!window.AdminPageBridge || typeof Select2 === 'undefined') {
        console.error('❌ Select2 not found! Make sure select2.js is loaded first.');
        return;
    }

    if (typeof LanguagesHelpersV2 === 'undefined') {
    ...
    console.log('✅ Dependencies loaded: AdminPageBridge, Select2, LanguagesHelpersV2');
    ...
    function initFallbackModule() {
        ...
        // Setup modal close handlers (uses LanguagesHelpersV2)
    ...
    async function openSetFallbackModal(languageId) {
        ...
        LanguagesHelpersV2.openModal('set-fallback-modal');
    }
