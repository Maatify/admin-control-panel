...
(function() {
    ...
    const idRenderer = function(value) {
        const canView = window.countriesCapabilities?.can_view_country_translations ?? false;
        if (!canView) return '<span class="text-gray-900 dark:text-gray-200">' + value + '</span>';
        return '<a href="/geo/countries/' + value + '/translations" class="text-blue-600 dark:text-blue-400 hover:underline font-medium">' + value + '</a>';
    };
