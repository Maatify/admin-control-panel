...
use Maatify\AdminKernel\Domain\ExchangeRates\List\ProviderListCapabilities;
...
final readonly class ProvidersQueryController
{
    ...
    public function __invoke(Request $request, Response $response): Response
    {
        ...
        $capabilities = ProviderListCapabilities::define();
