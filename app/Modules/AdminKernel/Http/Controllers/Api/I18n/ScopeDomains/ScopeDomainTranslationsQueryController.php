...
final readonly class ScopeDomainTranslationsQueryController
{
    ...
    public function __invoke(Request $request, Response $response, array $args): Response
    {
        ...
        // 3) Capabilities
        $capabilities = I18nScopeDomainTranslationsListCapabilities::define();
        ...
        // 6) Execute reader
        $result = $this->reader->queryScopeDomainTranslations($scopeCode, $domainCode, $query, $filters);
