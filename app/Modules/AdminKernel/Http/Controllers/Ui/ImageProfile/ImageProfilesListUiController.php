...
final readonly class ImageProfilesListUiController
{
    ...
    public function __invoke(Request $request, Response $response): Response
    {
        ...
        $capabilities = [
            'can_create' => $this->uiPermissionService->hasPermission($adminId, 'image_profiles.create'),
            'can_update' => $this->uiPermissionService->hasPermission($adminId, 'image_profiles.update'),
            'can_active' => $this->uiPermissionService->hasPermission($adminId, 'image_profiles.set_active'),
        ];
