 ...
 */
final readonly class I18nDomainUsageService
{
    ...
    public function isDomainCodeInUse(string $code): bool
    {
        return $this->scopeDomains->hasScopeForDomainCode($code) || $this->i18nKey->hasKeysForDomainCode($code);
    }
}
