...
abstract class AdminKernelUnsupportedExceptionBase extends UnsupportedMaatifyException
{
    /**
    ...
    public function __construct(
        ...
        if ($errorCodeOverride === null) {
            $errorCodeOverride = AdminKernelErrorCodeEnum::INVALID_OPERATION;
        }
    ...
    {
        return AdminKernelErrorCodeEnum::INVALID_OPERATION;
    }
}
