...
class BehaviorTraceLoggerMysqlRepository implements BehaviorTraceLoggerInterface
{
    ...
    public function write(BehaviorTraceEventDTO $dto): void
    {
        ...
        try {
            ...
            throw new BehaviorTraceStorageException('Failed to write behavior trace log: ' . $e->getMessage(), 0, $e);
