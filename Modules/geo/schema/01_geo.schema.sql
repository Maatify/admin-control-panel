...
CREATE TABLE IF NOT EXISTS `geo_countries` (
    ...
    `is_state_required`     TINYINT(1)      NOT NULL DEFAULT 0 COMMENT 'Required fields from Aramex reference',
    `is_postcode_required`  TINYINT(1)      NOT NULL DEFAULT 0 COMMENT 'Required fields from Aramex reference',
