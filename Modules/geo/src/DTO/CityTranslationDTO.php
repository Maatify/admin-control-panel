...
/**
 * Immutable read-model for a single row in geo_city_translations.
 *
 ...
 * the translation.
 */
final readonly class CityTranslationDTO implements JsonSerializable
{
