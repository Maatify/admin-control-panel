...
/**
 * PDO implementation for all country translation read and write operations.
 *
...
final class PdoCountryTranslationRepository implements CountryTranslationRepositoryInterface
{
    ...
    public function listTranslationsForCountryPaginated(
        ...
        /** @var callable(array<string,mixed>): CountryTranslationDTO $factory */
    ...
    public function upsertCountryTranslation(UpsertCountryTranslationCommand $command): CountryTranslationDTO
    {
        ...
        $dto = $this->findCountryTranslation($command->countryId, $command->languageId);
        if ($dto === null) {
