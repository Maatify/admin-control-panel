...
use Maatify\GeoSlim\Admin\Domain\List\CountryListCapabilities;
use Maatify\Validation\Guard\ValidationGuard;
use Maatify\Validation\Schemas\SharedListQuerySchema;
use Psr\Http\Message\ResponseInterface as Response;
use Psr\Http\Message\ServerRequestInterface as Request;

final readonly class CountriesQueryController
{
    ...
    public function __invoke(Request $request, Response $response): Response
    {
        ...
        // 3) Capabilities
        $capabilities = CountryListCapabilities::define();
        ...
        // 5) Execute service
        $result = $this->queryService->paginateCountries(
            page:          $query->page,
