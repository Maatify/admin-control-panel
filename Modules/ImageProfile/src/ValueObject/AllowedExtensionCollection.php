...
/**
 * Immutable collection of normalized image file extensions.
 *
 * Rules:
 *   - values are stored lowercase
 *   - a leading dot is stripped ("JPG" and ".jpg" both become "jpg")
 *   - duplicates are removed (stable order)
 *   - empty strings are ignored
 *
 * This class is the ONLY accepted representation of an allowed-extensions
 * list inside the package. No array-based representation is exposed on
 * the public API.
 *
 * @implements IteratorAggregate<int, string>
 */
final class AllowedExtensionCollection implements IteratorAggregate, Countable, JsonSerializable
{
    /**
     * @var list<string>
     */
     ...
     * Accepts an empty or null string and produces an empty collection.
     */
    ...
    {
        $needle = self::normalize($extension);
        if ($needle === '') {
            return false;
        }
