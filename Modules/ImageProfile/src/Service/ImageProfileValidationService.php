...
final readonly class ImageProfileValidationService implements ImageProfileValidationServiceInterface
{
    public function __construct(private ImageProfileQueryReaderInterface $queryReader) {}
