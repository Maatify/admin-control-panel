...
final class ImageProfileCommandService
{
    public function __construct(
        private readonly ImageProfileCommandRepositoryInterface $commandRepo,
        private readonly ImageProfileQueryReaderInterface $queryReader,
    ) {}
