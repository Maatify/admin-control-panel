...
namespace Maatify\ImageProfile\Tests\Unit\Validator;
...
final class ImageProfileValidatorPhase9Test extends TestCase
{
    ...
    public function test_aspect_ratio_and_transparency_both_collected_for_jpeg_on_landscape_profile(): void
    {
        ...
        $provider = new ArrayImageProfileProvider(
            (new \Maatify\ImageProfile\Entity\ImageProfileEntity(
                id:                   99,
                ...
                maxHeight:            null,
                maxSizeBytes:         null,
                allowedExtensions:    new \Maatify\ImageProfile\ValueObject\AllowedExtensionCollection(),
                allowedMimeTypes:     new \Maatify\ImageProfile\ValueObject\AllowedMimeTypeCollection(),
                isActive:             true,
                notes:                null,
                minAspectRatio:       16 / 9,
