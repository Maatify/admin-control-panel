...
The Currencies page allows administrators to manage the list of monetary currencies used across the platform. Currencies represent the types of money available for pricing, billing, and transactions. The platform relies on this list to correctly format and display financial values to users in their localized context.

## How to Access Currencies

To view and manage the platform's supported currencies:
1. Locate the left sidebar navigation menu.
2. Click on the **Currencies** link.
3. This opens the main Currencies List page.
...
To update a currency's translation, follow these steps:

1. **Open currencies:** Navigate to the Currencies List page from the sidebar.
2. **Select a currency:** Find the currency you wish to edit and click on it to access its details.
3. **Open translations:** Proceed to the Currency Translations section for that selected currency.
4. **Edit values:** Locate the specific language you want to update, click the edit action, input the new translated value in the provided field, and save your changes.
...
* Ensure that currency codes and symbols adhere to standard financial formatting.
* Changes to currency translations only affect the displayed text, not the actual financial value or conversion rates.
